from src.mcq_gen import mcq_gen
# The above import statement will import the mcq_gen module from the src directory.
import os
import json
import traceback
import pandas as pd
...
load_dotenv() # this is holding key value pairs in the .env file
